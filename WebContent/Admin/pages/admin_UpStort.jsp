	...
	<div class="container-scroller">
		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="content-wrapper">
				<p class="text-primary" style="">Lucy_Book--类型修改</p>
				<div class="col-12 grid-margin stretch-card">
					<div class="card-body">
						<h4 class="card-title">您又有新点子啦</h4>
						<p class="card-description">来将它实现吧</p>
						<form class="forms-sample"
							action="${pageContext.request.contextPath}/Admin/pages/admin_upStort"
							method="post">
							<input type="hidden" name="tableid" value="${stort.stid }">
							<div class="form-group row">
								<label for="exampleInputUsername2"
									class="col-sm-3 col-form-label">类型编号</label>
								<div class="col-sm-9">
									<input type="text" class="form-control"
										id="exampleInputUsername3" disabled="disabled"
										value="${stort.stid }">
								</div>
							</div>
							<div class="form-group row">
								<label for="exampleInputUsername2"
									class="col-sm-3 col-form-label">类型名</label>
								<div class="col-sm-9">
									<input type="text" class="form-control"
										id="exampleInputUsername3" name="bookName"
										value="${stort.stName }">
								</div>
							</div>
