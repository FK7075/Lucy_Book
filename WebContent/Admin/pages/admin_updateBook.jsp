	...
	<div class="container-scroller">
		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="content-wrapper">
				<p class="text-primary" style="">Lucy_Book--修改书本信息</p>
				<div class="col-12 grid-margin stretch-card">
					<div class="card-body">
						<h4 class="card-title">书库中书本信息更新了？</h4>
						<p class="card-description">我们来修改吧</p>
						<form class="forms-sample"
							action="${pageContext.request.contextPath}/Admin/pages/admin_updateBook"
							method="post">
							<div class="form-group row">
								<label for="exampleInputUsername1"
									class="col-sm-3 col-form-label">书本编号</label>
								<div class="col-sm-9">
									<input type="text" class="form-control"
										id="exampleInputUsername2" value="${book.bid }" name="tableid">
								</div>
							</div>
							<div class="form-group row">
								<label for="exampleInputUsername2"
									class="col-sm-3 col-form-label">书名</label>
								<div class="col-sm-9">
									<input type="text" class="form-control"
										id="exampleInputUsername2" value="${book.bName }"
										name="bookName">
								</div>
							</div>
							<div class="form-group row">
								<label for="exampleInputUsername2"
									class="col-sm-3 col-form-label">库存</label>
								<div class="col-sm-9">
									<input type="text" class="form-control"
										id="exampleInputUsername3" value="${book.bStore }"
										name="bookStore">
								</div>
							</div>
							<div class="form-group row">
								<label for="exampleInputUsername2"
									class="col-sm-3 col-form-label">单价</label>
								<div class="col-sm-9">
									<input type="text" class="form-control"
										id="exampleInputUsername3" value="${book.bPrice }"
										name="bookPrice">
								</div>
							</div>
							<div>
								<div class="form-group">
									...
									<textarea class="form-control" id="exampleTextarea1" rows="4"
										name="bookDetail">${book.bdetail }</textarea>
								</div>
							</div>
