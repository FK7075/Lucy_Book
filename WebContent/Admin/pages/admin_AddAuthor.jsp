	...
	<div class="container-scroller">
		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="content-wrapper">
				<p class="text-primary" style="">Lucy_Book--添加作者</p>
				<div class="col-12 grid-margin stretch-card">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">新来了一个作者小可爱</h4>
							<p class="card-description">让我们更了解T吧</p>
							<form class="forms-sample" enctype="multipart/form-data"
								method="post"
								action="${pageContext.request.contextPath}/Admin/pages/admin_authorUpload">
								<div class="form-group">
									<label for="exampleInputName1">作者姓名</label> <input type="text"
										class="form-control" id="exampleInputName1" placeholder="作者姓名"
										name="bookName">
								</div>
								<div class="form-group">
									<label for="exampleSelectGender">作者性别</label> <select
										class="form-control" id="exampleSelectGender" name="password">
										<option value="男">阳光大帅哥</option>
										<option value="女">可爱萌妹子</option>
									</select>
								</div>
								<div class="form-group">
									<label for="exampleInputName1">国籍</label> <input type="text"
										class="form-control" id="exampleInputName1" placeholder="国籍"
										name="username">
								</div>
								<div class="form-group">
									<label for="exampleInputName1">出生日期</label> <input type="text"
										class="form-control" id="exampleInputName1" placeholder="出生日期"
										name="admPass">
								</div>
								<div class="form-group">
									<label>作者图片</label> <input type="file" name="bookUp"
										class="file-upload-default">
									<div class="input-group col-xs-12">
										<input type="text" class="form-control file-upload-info"
											disabled placeholder="作者图片"> <span
