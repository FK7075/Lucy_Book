		...
		<div class="container-scroller">
				...
				<div class="navbar-menu-wrapper d-flex align-items-stretch">
					...
					<ul class="navbar-nav navbar-nav-right">
						...
						<li class="nav-item nav-logout d-none d-lg-block">
							<a class="nav-link" href="${pageContext.request.contextPath}/Admin/pages/admin_loginOut">
			...
			<div class="container-fluid page-body-wrapper">
					...
					<ul class="nav">
						...
						<li class="nav-item">
							...
							<div class="collapse" id="ui-basic4">
								<ul class="nav flex-column sub-menu">
									<li class="nav-item">
										<a class="nav-link" href="addAdmin.jsp" onclick="return Click();">添加管理员</a>
									</li>
						...
						<li class="nav-item">
							<a class="nav-link" data-toggle="collapse" href="#ui-basic9" aria-expanded="false" aria-controls="ui-basic9">
								<span class="menu-title">美文管理</span>
								<i class="menu-arrow"></i>
							...
							<div class="collapse" id="ui-basic9">
								<ul class="nav flex-column sub-menu">
									<li class="nav-item">
										<a class="nav-link" href="${pageContext.request.contextPath}/Admin/pages/admin_showNotes">所有美文</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="admin_addNotes.jsp">新增美文</a>
									</li>
								</ul>
							</div>
						</li>
				...
				<div class="content-wrapper">
					<p class="text-primary" style="b">Lucy_Book--美文管理</p>
					<div class="content-wrapper">
						<table class="table table-bordered">
							...
							%>
							<tbody>
							<c:forEach items="${noteslist }" var="nl">
							<%
							switch (i%5){
							case 0:
							...
							%> 
								<tr class=<%=color %> align="center">
									...
									<td>美文<%=j++ %></td>
									<td>
										<a href="${pageContext.request.contextPath}/Admin/pages/admin_showNoteInfo?id=${nl.bufid}">编辑</a>&nbsp;&nbsp;
										<a href="${pageContext.request.contextPath}/Admin/pages/admin_delNotes?id=${nl.bufid}" onclick="return click1()">删除</a>
									</td>
								</tr>
							</c:forEach>
							</tbody>
