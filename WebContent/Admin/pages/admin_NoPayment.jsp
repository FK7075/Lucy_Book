		...
		<div class="container-scroller">
			...
			<div class="container-fluid page-body-wrapper">
				...
				<div class="content-wrapper">
					<p class="text-primary" style="b">Lucy_Book--未付款账单</p>
					<div class="content-wrapper">
						<table class="table table-bordered">
							...
							%> 
								<tr class=<%=color %> align="center">
									...
									<td>${oi.ordTime}</td>
									<td>￥${oi.ordTotal}</td>
									<td>${oi.ordPayState}</td>
									<td>
										<a href="${pageContext.request.contextPath}/Admin/pages/admin_showDetail?id=${oi.ordid}">查看明细</a>&nbsp;&nbsp;
										<a href="${pageContext.request.contextPath}/Admin/pages/admin_delOrder?id=${oi.ordid}" onclick="return click1()">删除</a>
									</td>
								</tr>
							</c:forEach>
							</tbody>
