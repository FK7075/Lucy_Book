	...
	<div class="container-scroller">
		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="content-wrapper">
				<p class="text-primary" style="">Lucy_Book--订单明细</p>
				<div class="content-wrapper">
					<h2>${detailInfolist[0].uName }</h2>
					<h5>
						<b>电话:</b>${detailInfolist[0].uTel }</h5>
					<h5>
						<b>用户备注:</b>${detailInfolist[0].userdetail }</h5>
						...
						<tbody>
							<c:forEach items="${detailInfolist }" var="di">
								...
								<tr class=<%=color%> align="center">
									<td><img
										src="${pageContext.request.contextPath}/${di.bphoto}"
