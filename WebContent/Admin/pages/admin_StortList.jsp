				...
				<div class="content-wrapper">
							...
							<c:forEach items="${stortlist }" var="sl">
								...
								<tr class=<%=color%> align="center">
									...
									<td><a
										...
										<a
										href="${pageContext.request.contextPath}/Admin/pages/admin_delStort?stid=${sl.stid}"
					...
					<div class="btn-group" role="group" aria-label="Basic example">
						<button id="bu1" type="button" class="btn btn-primary"
							onclick="window.location.href='${pageContext.request.contextPath}/Admin/pages/admin_showStort?pages=${page-1 }';">上一页</button>
						<button id="bu2" type="button" class="btn btn-primary"
							onclick="window.location.href='${pageContext.request.contextPath}/Admin/pages/admin_showStort?&pages=${page+1 }';">下一页</button>
					</div>
				</div>
