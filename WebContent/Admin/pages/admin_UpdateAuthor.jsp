	...
	<div class="container-scroller">
		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="content-wrapper">
				<p class="text-primary" style="">Lucy_Book--修改作者信息</p>
				<div class="col-12 grid-margin stretch-card">
					<div class="card-body">
						<h4 class="card-title">作者信息需要修改了？</h4>
						<p class="card-description">好的，来吧</p>
						<form class="forms-sample"
							action="${pageContext.request.contextPath}/Admin/pages/admin_upAuthor"
							method="post">
							<input type="hidden" value="${author.autid}" name="tableid" />
							<div class="form-group row">
								<label for="exampleInputUsername1"
									class="col-sm-3 col-form-label">作者编号</label>
								<div class="col-sm-9">
									<input type="text" class="form-control"
										id="exampleInputUsername2" value="${author.autid}"
										disabled="disabled">
								</div>
							</div>
							<div class="form-group row">
								<label for="exampleInputUsername2"
									class="col-sm-3 col-form-label">作者姓名</label>
								<div class="col-sm-9">
									<input type="text" class="form-control"
										id="exampleInputUsername2" value="${author.autName }"
										name="bookName">
								</div>
							</div>
							<div class="form-group row">
								<label for="exampleInputUsername2"
									class="col-sm-3 col-form-label">国籍</label>
								<div class="col-sm-9">
									<input type="text" class="form-control"
										id="exampleInputUsername3" value="${author.autPlace }"
										name="username">
								</div>
							</div>
							<div class="form-group row">
								<label for="exampleInputUsername2"
									class="col-sm-3 col-form-label">性别</label>
								<div class="col-sm-9">
									<input type="text" class="form-control"
										id="exampleInputUsername3" value="${author.autSex }"
										name="password">
								</div>
							</div>
							<div class="form-group row">
								<label for="exampleInputUsername2"
									class="col-sm-3 col-form-label">出生日期</label>
								<div class="col-sm-9">
									<input type="text" class="form-control"
										id="exampleInputUsername3" value="${author.autdate }"
										name="admPass">
								</div>
							</div>
							<div>
								<div class="form-group">
									...
									<textarea class="form-control" id="exampleTextarea1" rows="4"
										name="bookDetail">${author.autdetail }</textarea>
								</div>
							</div>
