	...
	<div class="container-scroller">
		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="content-wrapper">
				<p class="text-primary" style="">Lucy_Book--新书上架</p>
				<div class="col-12 grid-margin stretch-card">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">新书信息</h4>
							<p class="card-description">请完善下面的信息</p>
							<form class="forms-sample" enctype="multipart/form-data"
								method="post"
								action="${pageContext.request.contextPath}/Admin/pages/admin_bookUpload">
								<div class="form-group">
									<label for="exampleInputName1">书名</label> <input type="text"
										class="form-control" id="exampleInputName1" placeholder="书名"
										name="bookName">
								</div>
								<div class="form-group">
									<label for="exampleInputName1">单价</label> <input type="text"
										class="form-control" id="exampleInputName1" placeholder="单价"
										name="bookPrice">
								</div>
								<div class="form-group">
									<label for="exampleInputName1">库存量</label> <input type="text"
										class="form-control" id="exampleInputName1" placeholder="库存量"
										name="bookStore">
								</div>
								<div class="form-group">
									<label>书本图片</label> <input type="file" name="bookUp"
										class="file-upload-default">
									<div class="input-group col-xs-12">
										<input type="text" class="form-control file-upload-info"
											disabled placeholder="书本图片"> <span
											class="input-group-append">
											<button class="file-upload-browse btn btn-gradient-primary"
												type="button">本地浏览</button>
										</span>
									</div>
								</div>
								<div class="form-group">
									<label for="exampleSelectGender">书本类型</label> <select
										class="form-control" id="exampleSelectGender" name="bookStort">
								...
								<div class="form-group">
									<label for="exampleSelectGender2">作者</label> <select
										class="form-control" id="exampleSelectGender2"
										name="bookAuthor">
