	...
	<div class="container-scroller">
		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="content-wrapper">
				<p class="text-primary" style="">Lucy_Book--所有订单</p>
				<div class="content-wrapper">
					<table class="table table-bordered">
						...
						<tbody>
							<c:forEach items="${orderInfolist }" var="oi">
								...
								<tr class=<%=color%> align="center">
									...
									<td><a
										href="${pageContext.request.contextPath}/Admin/pages/admin_showDetail?id=${oi.ordid}">查看明细</a>&nbsp;&nbsp;
									</td>
								</tr>
							</c:forEach>
						</tbody>
						<tr align="center">
							<td colspan="7"><a
								href="${pageContext.request.contextPath}/Admin/pages/admin_exportOrder">更新为最新</a>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
								href="${pageContext.request.contextPath}/Admin/pages/download?filename=order.xls">下载订单信息</a>
							</td>
						</tr>
					</table>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
