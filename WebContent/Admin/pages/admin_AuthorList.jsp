		...
		<div class="container-scroller">
			...
			<div class="container-fluid page-body-wrapper">
				...
				<div class="content-wrapper">
					<p class="text-primary" style="b">Lucy_Book--作者管理</p>
					<div class="content-wrapper">
						<table class="table table-bordered">
							...
							%> 
								<tr class=<%=color %> align="center">
								    <td><img src="${pageContext.request.contextPath}/${al.autPor}" style="border-radius:25px;width:50px;height:50px"></td>
									<td>${al.autName}</td>
									<td>${al.autSex}</td>
									<td>${al.autPlace}</td>
									<td>${al.autdate}</td>
									<td>
										<a href="${pageContext.request.contextPath}/Admin/pages/admin_showAuthorInfo?id=${al.autid}">查看</a>&nbsp;&nbsp;
										<a href="${pageContext.request.contextPath}/Admin/pages/admin_showUpAuthor?id=${al.autid}">编辑</a>&nbsp;&nbsp;
										<a href="${pageContext.request.contextPath}/Admin/pages/admin_delAuthor?id=${al.autid}" onclick="return click1()">删除</a>
									</td>
								</tr>
							</c:forEach>
							</tbody>
						...
						<div class="btn-group" role="group" aria-label="Basic example">
							<button id="bu1" type="button" class="btn btn-primary" onclick="window.location.href='${pageContext.request.contextPath}/Admin/pages/admin_showAuthor?pages=${page-1 }';">上一页</button>
							<button id="bu2" type="button" class="btn btn-primary" onclick="window.location.href='${pageContext.request.contextPath}/Admin/pages/admin_showAuthor?&pages=${page+1 }';">下一页</button>
						</div>
					</div>
