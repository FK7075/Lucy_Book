	...
	<div class="container-scroller">
		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="content-wrapper">
				<p class="text-primary" style="">Lucy_Book--类型添加</p>
				<div class="col-12 grid-margin stretch-card">
					<div class="card-body">
						<h4 class="card-title">书库将会来一大波书本小伙伴</h4>
						<p class="card-description">来为他们添加新的类型名称吧</p>
						<form class="forms-sample"
							action="${pageContext.request.contextPath}/Admin/pages/admin_addStort"
							method="post">
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control"
										id="exampleInputUsername3" placeholder="添加一个响亮的类型名"
										name="bookName">
								</div>
							</div>
