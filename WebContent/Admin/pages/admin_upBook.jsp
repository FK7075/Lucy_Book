	...
	<div class="container-scroller">
		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="content-wrapper">
				<p class="text-primary" style="">Lucy_Book--库存警报</p>
				<div class="col-12 grid-margin stretch-card">
					<div class="card-body">
						<h4 class="card-title">您的库存不足了</h4>
						<p class="card-description">来添加一点吧</p>
						<form class="forms-sample"
							action="${pageContext.request.contextPath}/Admin/pages/admin_upInven"
							method="post">
							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control"
										id="exampleInputUsername2" value="${book.bid }"
										disabled="disabled">
								</div>
							</div>
							<div class="form-group row">
