	...
	<div class="wrapper kode-header-class-3">
		...
		<div class="kode-content padding-tb-50">
			...
			<div class="container">
						...
						<div class="col-md-4 col-sm-6 ">
							<div class="kode-author kode-author-2">
								<a href="#"><img
									...
									style="width: 370px; height: 370px" alt=""></a>
								<div class="kode-caption">
									...
									<div class="social-icon">
										<ul>
											<li><a
												href="${pageContext.request.contextPath }/User/pages/user_authorToBooks?id=${al.autid}">所有作品</a></li>
											<li><a
												href="${pageContext.request.contextPath }/User/pages/user_autDetail?id=${al.autid}">详细信息</a></li>
										</ul>
									</div>
								</div>
							</div>
				...
				<ul class="pagination">
					<li><a
						href="${pageContext.request.contextPath }/User/pages/user_allAuthor?pages=${page-1}"
						aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
					</a></li>
					<li><a
						href="${pageContext.request.contextPath }/User/pages/user_allAuthor?pages=1">1</a></li>
					<li><a
						href="${pageContext.request.contextPath }/User/pages/user_allAuthor?pages=3">2</a></li>
					<li><a
						href="${pageContext.request.contextPath }/User/pages/user_allAuthor?pages=3">3</a></li>
					<li><a
						href="${pageContext.request.contextPath }/User/pages/user_allAuthor?pages=4">4</a></li>
					<li><a
						href="${pageContext.request.contextPath }/User/pages/user_allAuthor?pages=5">5</a></li>
					<li><a
						href="${pageContext.request.contextPath }/User/pages/user_allAuthor?pages=${page+1}"
