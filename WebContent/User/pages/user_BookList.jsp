	...
	<div class="wrapper kode-header-class-3">
		...
		<div class="kode-content padding-tb-50">
			...
			<div class="container">
				...
				<ul class="pagination">
					<li><a
						href="${pageContext.request.contextPath }/User/pages/user_allBook?pages=${page-1 }"
						aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
					</a></li>
					<li><a
						href="${pageContext.request.contextPath }/User/pages/user_allBook?pages=1">1</a></li>
					<li><a
						href="${pageContext.request.contextPath }/User/pages/user_allBook?pages=2">2</a></li>
					<li><a
						href="${pageContext.request.contextPath }/User/pages/user_allBook?pages=3">3</a></li>
					<li><a
						href="${pageContext.request.contextPath }/User/pages/user_allBook?pages=4">4</a></li>
					<li><a
						href="${pageContext.request.contextPath }/User/pages/user_allBook?pages=5">5</a></li>
					<li><a
						href="${pageContext.request.contextPath }/User/pages/user_allBook?pages=${page+1 }"
