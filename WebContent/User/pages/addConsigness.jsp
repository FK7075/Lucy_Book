...
<body>
	...
	<div class="wrapper kode-header-class-3">
		...
		<div class="kode-content padding-tb-50">
			<div class="container">
			<h2>填写收货人信息</h2>
			<form action="${pageContext.request.contextPath }/User/pages/user_addConsigness" method="post">
			<label>收货人姓名</label>
			<input type="text" name="uName"  placeholder="收货人姓名">
			<label>收货人电话</label>
			<input type="text" name="uTel"  placeholder="收货人电话">
			<label>收货人地址</label>
			<input type="text" name="uPass"  placeholder="收货人地址">
